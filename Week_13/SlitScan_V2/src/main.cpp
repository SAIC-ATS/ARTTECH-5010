...
int yPosition = 0; // The current x position of the slits in our pixels.
...
void update() 
{
    ...
    if (grabber.isFrameNew())
    {
        ...
        int slitPositionY = grabber.getHeight() / 2;
