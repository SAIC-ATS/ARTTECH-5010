...
// a function that removes commas and periods (could be more)
std::string TextUtilities::convertNewLinesToSpaces(const std::string& buffer)
{
    static Poco::RegularExpression regex("[\n]+");
...
// a function that removes commas and periods (could be more)
std::string TextUtilities::toLowerCase(const std::string& buffer)
{
    return Poco::UTF8::toLower(buffer);
}

// a function that removes commas and periods (could be more)
std::string TextUtilities::toUpperCase(const std::string& buffer)
{
    return Poco::UTF8::toUpper(buffer);
}
